...
<div class="main" id="main_interface"
     style="background-color:rgba(255,255,224,9);position:absolute;left: 0px;top: 50px;width: 2000px;height: 80px">
    ...
    <form action="/privacy" method="post">
        <input type="submit" value="私人培训" style="font-size: 25px;position:absolute;left: 1300px;top:20px">
    </form>
