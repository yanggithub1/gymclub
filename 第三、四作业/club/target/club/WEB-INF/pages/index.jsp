...
<form action="/main" method="post">
    ...
    <div class="fg"
         style="background-color:rgba(189,183,107,0.5);position:absolute;left: 800px;top: 200px;width: 400px;height: 600px">
    ...
    background-color: transparent;">
        ...
        <div class="fg" id="log_reg" style="position:relative;left: 50px;top:100px;width: 300px;height: 150px">
            <input type="submit" value="login"
                   style="border:0;outline:none;background-color:rgba(189,183,107,0.5);font-size:30px;position:relative;left: 50px"/>
            ...
            <%--</script>--%>
            <button type="button"
                    style="border:0;outline:none;background-color:rgba(189,183,107,0.5);font-size:30px;position:relative;left: 100px">
                register
            </button>
        </div>
